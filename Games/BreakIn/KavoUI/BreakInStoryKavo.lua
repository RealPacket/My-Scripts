...
function openSafe()
	...
	game:GetService("ReplicatedStorage").RemoteEvents.PaintingClicked
		:FireServer("http://www.roblox.com/asset/?id=363240671")
	game:GetService("ReplicatedStorage").RemoteEvents.PaintingClicked:FireServer("rbxassetid://3195645922")
	game:GetService("ReplicatedStorage").RemoteEvents.PaintingClicked
		:FireServer("http://www.roblox.com/asset/?id=178210631")
	game:GetService("ReplicatedStorage").RemoteEvents.PaintingClicked
		:FireServer("http://www.roblox.com/asset/?id=3246691515")
	game:GetService("ReplicatedStorage").RemoteEvents.PaintingClicked:FireServer("rbxassetid://3195645674")
	game.StarterGui:SetCore("SendNotification", {
		Title = "Code Finder",
		Duration = 5,
		Text = "Code is: "
			.. CodeNote.SurfaceGui.TextLabel.Text
			.. ", Sending Remote Event With parameter with the code..",
	})
...
GSec4:NewToggle(
	...
	function(t)
		...
		local slipFunc = hookfunction(iceScript.mat, function()
			print("Dying is strictly prohibited! DO NOT TRY TO DIE.")
			return
		end)
	end
)
...
OUISec:NewButton("Load w/ notifications", "Loads Original UI For Break In Story Script with Notifs on", function()
