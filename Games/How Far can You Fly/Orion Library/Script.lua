...
local Lib = OrionLib:MakeWindow({
	Name = "How Far Can You Fly Script",
	HidePremium = false,
	SaveConfig = true,
	ConfigFolder = "Orion",
})
...
GTab:AddToggle({
	...
	Callback = function(val)
		...
		for i, v in pairs(game:GetService("Workspace"):GetDescendants()) do
			if
				v.name == "PlrAccountCheck"
				or v.Name == "PlrAccountAgeCheck"
				or v.name == "PlrAccountAgeCheck"
				or v.name == "plrAccountAgeCheck"
				or v.Name == "PlrAcountAgeCheck"
			then
				v:Destroy()
				if v.name then
...
STab:AddButton({
	...
	Callback = function()
		loadstring(
			game:HttpGet(
				"https://gist.githubusercontent.com/DinosaurXxX/b757fe011e7e600c0873f967fe427dc2/raw/ee5324771f017073fc30e640323ac2a9b3bfc550/dark%2520dex%2520v4",
				true
			)
		)()
	end,
