-- NOTE: please update this file every time you make a breaking change.
...
type Events = {
	...
	--- Unknown event, assume it's a signal
	[any]: SignalInstance,
}
...
--- Shown in help command, also helps auto complete catch the right type for each argument.
type commandParamInfo = {
	--- The name of this argument.
	name: string,
	--- An optional description for this argument.
	description: string?,
	--- type = typeOfArg (e.x. primatives, Instances/Objects like Player, ...)
	type: string,
}
...
type ChatLog = {
	...
	Author: Player,
	--- The contents/text of this message.
	Message: string,
	Recipient: Player,
	--- The time of this message being recived.
	timeStamp: DateTime,
}
...
type ConsoleLogs = {
	--- A list of errors .
	Errors: { string },
	--- A list of warnings that were emitted into the console.
	Warnings: { string },
	--- A list of logs.
	Logs: { string },
}
